{{- define "helmValues.kube-prom-stack" }}
...
prometheus:
  ...
  prometheusSpec:
    ...
    ##
    externalLabels: {cluster: "JeanKluster"}
    ...
    remoteWrite:
      - url: "https://prometheus-prod-24-prod-eu-west-2.grafana.net/api/prom/push"  # Remplacez <region> par la région appropriée (ex: us, eu, etc.)
        basicAuth:
          username:
