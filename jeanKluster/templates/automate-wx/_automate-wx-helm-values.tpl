  ...
  main:
    containers:
      main:
        image:
          # -- image repository
          repository: ghcr.io/toboshii/automate-wx
          # -- image pull policy
...
# -- Configures automate-wx settings for this instance.
# @default -- See below
automate-wx:
  defaultEnable: false
  namespaceSelector:
...
ingress:
  main:
    ...
    defaultBackend: '{"service": {"name": "automate-wx","port": {"number": 3000}}}'

persistence:
  config:
    enabled: true
    type: configMap
    name: automate-wx-settings
